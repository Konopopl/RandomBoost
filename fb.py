...
class ForestBoostingClassifier(ForestClassifier):
    def __init__(
        self,
        n_estimators=100,
        *,
        ...
        self.n_gb_estimators = n_gb_estimators
        self.loss = loss
    ...
    def _make_estimator(self, append=True, random_state=None):
        ...
        params['n_estimators'] = self.n_gb_estimators  # Устанавливаем n_gb_estimators
    ...
    def feature_importances_std_(self):
        ...
        return np.sqrt(np.var(all_importances, axis=0)/len(self.estimators_) )


class BaseGradientBoostingRegressor(GradientBoostingRegressor):
    """
    Обертка над GradientBoostingRegressor для совместимости с ForestRegressor.
    """
    def fit(self, X, y, sample_weight=None, check_input=True): 
        y = np.ravel(y)
...
class ForestBoostingRegressor(ForestRegressor):
    def __init__(
        self,
        n_estimators=100,
        *,
        ...
        # Создаем базовый оценщик с параметрами градиентного бустинга
        base_estimator = BaseGradientBoostingRegressor(
            n_estimators=n_gb_estimators,
            loss=loss,
            learning_rate=learning_rate,
            subsample=subsample,
        ...
        # Инициализируем ForestRegressor
        super().__init__(
            estimator=base_estimator,
            n_estimators=n_estimators,
            estimator_params=estimator_params,
